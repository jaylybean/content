...
clone_repository "https://gitlab-ci-token:${CI_JOB_TOKEN}@${CI_SERVER_HOST}/xsoar/gitlab-ci" "$UNDERSCORE_BRANCH"
...
clone_repository "https://gitlab-ci-token:${CI_JOB_TOKEN}@${CI_SERVER_HOST}/xsoar/content-test-conf" "$UNDERSCORE_BRANCH"
